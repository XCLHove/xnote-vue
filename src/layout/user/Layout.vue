...
const menus = ref([
    {
        title: '笔记', index: '1', event: () => {
        },
        children: [
            {title: '发布笔记', index: '1-1', event: () => router.push('/edit/')},
            {title: '我的笔记', index: '1-2', event: () => router.push(`/notes/user`)},
        ]
    }
])
                ...
                <div class="head">
                    ...
                    <div class="avatar">
                        <el-dropdown>
                            ...
                            <template #dropdown>
                                <el-dropdown-menu>
                                    <el-dropdown-item v-if="showLogin" @click="showUserLogin()">登录</el-dropdown-item>
                                    <el-dropdown-item v-if="showLogin" @click="showUserRegister()">注册</el-dropdown-item>
                                    <el-dropdown-item v-if="!showLogin" @click="logout">注销</el-dropdown-item>
                                </el-dropdown-menu>
                            </template>
                        </el-dropdown>
                    </div>
                        ...
                        <div class="menu">
                            <el-menu>
                                ...
                                <el-sub-menu v-for="menu in menus" :index="menu.index">
                                    ...
                                    <el-menu-item v-for="menuChild in menu.children" :index="menuChild.index"
